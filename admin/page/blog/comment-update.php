...
if(isset($_POST["update"])) {
    ...
    $status     = $_POST["status"];
    mysqli_query($connect, "UPDATE comment SET post_id = '$post_id', name = '$name', comment = '$comment',
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form role="form" action="" method="post">
                            ...
                            <div class="form-group">
                                <label>Reply</label>
                                <textarea class="form-control" rows="3" name="comment"><?php echo $row_edit["comment"]?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Status</label>
                                <div class="radio">
